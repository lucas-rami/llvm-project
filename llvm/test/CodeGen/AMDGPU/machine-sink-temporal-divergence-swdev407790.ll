...
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
; CHECK-NEXT:    v_mul_lo_u32 v45, v0, 14
; CHECK-NEXT:    v_mov_b32_e32 v31, v40
; CHECK-NEXT:    v_mov_b32_e32 v0, 1
; CHECK-NEXT:    s_getpc_b64 s[16:17]
; CHECK-NEXT:    s_add_u32 s16, s16, _Z7barrierj@rel32@lo+4
...
; CHECK-NEXT:    v_add_nc_u32_e32 v44, 0x3c04, v45
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[16:17]
...
; CHECK-NEXT:    s_mov_b32 s52, 0
; CHECK-NEXT:    s_mov_b32 s4, 0
; CHECK-NEXT:    ds_write_b8 v45, v43 offset:15364
...
; CHECK-NEXT:    ds_read_u8 v0, v0
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_cmp_eq_u16_sdwa s4, v45, v0 src0_sel:BYTE_0 src1_sel:DWORD
...
; CHECK-NEXT:  ; %bb.12: ; %.32
; CHECK-NEXT:    ; in Loop: Header=BB1_1 Depth=1
; CHECK-NEXT:    v_add_nc_u32_e32 v0, -1, v41
; CHECK-NEXT:    v_cmp_lt_u32_e64 s4, 59, v43
; CHECK-NEXT:    v_cmp_ge_u32_e32 vcc_lo, s53, v0
; CHECK-NEXT:    s_or_b32 s4, vcc_lo, s4
; CHECK-NEXT:    s_and_b32 s4, exec_lo, s4
