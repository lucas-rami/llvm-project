...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_f32_16x16x32_f16 v[0:3], v[0:3], v[4:7], v[8:11] cbsz:1 abid:1 blgp:1
; HEURRC-NEXT:    s_setpc_b64 s[30:31]
;
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x34
; HEURRC-NEXT:    s_load_dwordx4 s[12:15], s[0:1], 0x54
; HEURRC-NEXT:    v_mov_b32_e32 v12, 0
; HEURRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
; HEURRC-NEXT:    v_mov_b64_e32 v[8:9], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], s[10:11]
; HEURRC-NEXT:    v_mov_b64_e32 v[10:11], s[14:15]
; HEURRC-NEXT:    s_nop 1
; HEURRC-NEXT:    v_mfma_f32_16x16x32_f16 v[0:3], v[0:3], v[4:7], v[8:11]
; HEURRC-NEXT:    s_nop 6
; HEURRC-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1]
; HEURRC-NEXT:    s_endpgm
;
; VGPRRC-LABEL: test_mfma_f32_16x16x32_f16_no_agpr__vgprcd:
; VGPRRC:       ; %bb.0:
; VGPRRC-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x34
; VGPRRC-NEXT:    s_load_dwordx4 s[12:15], s[0:1], 0x54
; VGPRRC-NEXT:    v_mov_b32_e32 v12, 0
; VGPRRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x24
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; VGPRRC-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; VGPRRC-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
; VGPRRC-NEXT:    v_mov_b64_e32 v[8:9], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[6:7], s[10:11]
; VGPRRC-NEXT:    v_mov_b64_e32 v[10:11], s[14:15]
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_f32_16x16x32_f16 v[0:3], v[0:3], v[4:7], v[8:11]
; VGPRRC-NEXT:    s_nop 6
; VGPRRC-NEXT:    global_store_dwordx4 v12, v[0:3], s[0:1]
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; HEURRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; HEURRC-NEXT:    v_mov_b64_e32 v[12:13], 48
; HEURRC-NEXT:    v_mov_b64_e32 v[14:15], 32
; HEURRC-NEXT:    v_mov_b64_e32 v[16:17], 16
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], s[20:21]
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], s[22:23]
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], s[24:25]
; HEURRC-NEXT:    v_accvgpr_write_b32 a0, s4
; HEURRC-NEXT:    v_mov_b64_e32 v[6:7], s[26:27]
; HEURRC-NEXT:    v_accvgpr_write_b32 a1, s5
; HEURRC-NEXT:    v_accvgpr_write_b32 a2, s6
; HEURRC-NEXT:    v_accvgpr_write_b32 a3, s7
; HEURRC-NEXT:    v_accvgpr_write_b32 a4, s8
; HEURRC-NEXT:    v_accvgpr_write_b32 a5, s9
; HEURRC-NEXT:    v_accvgpr_write_b32 a6, s10
; HEURRC-NEXT:    v_accvgpr_write_b32 a7, s11
; HEURRC-NEXT:    v_accvgpr_write_b32 a8, s12
; HEURRC-NEXT:    v_accvgpr_write_b32 a9, s13
; HEURRC-NEXT:    v_accvgpr_write_b32 a10, s14
; HEURRC-NEXT:    v_accvgpr_write_b32 a11, s15
; HEURRC-NEXT:    v_accvgpr_write_b32 a12, s16
; HEURRC-NEXT:    v_accvgpr_write_b32 a13, s17
; HEURRC-NEXT:    v_accvgpr_write_b32 a14, s18
; HEURRC-NEXT:    v_accvgpr_write_b32 a15, s19
; HEURRC-NEXT:    v_mov_b64_e32 v[18:19], 0
; HEURRC-NEXT:    v_mov_b32_e32 v8, s12
...
; HEURRC-NEXT:    v_mov_b32_e32 v9, s13
; HEURRC-NEXT:    v_mov_b32_e32 v10, s14
; HEURRC-NEXT:    v_mov_b32_e32 v11, s15
; HEURRC-NEXT:    s_nop 3
...
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    s_nop 0
; HEURRC-NEXT:    v_mov_b32_e32 v0, s4
; HEURRC-NEXT:    v_mov_b32_e32 v1, s5
; HEURRC-NEXT:    v_mov_b32_e32 v2, s6
; HEURRC-NEXT:    v_mov_b32_e32 v3, s7
...
; VGPRRC:       ; %bb.0:
; VGPRRC-NEXT:    s_load_dwordx8 s[20:27], s[0:1], 0x24
; VGPRRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
...
; VGPRRC-NEXT:    v_mov_b64_e32 v[8:9], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[10:11], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[12:13], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[14:15], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[50:51], 0
; VGPRRC-NEXT:    v_mov_b32_e32 v40, s12
; VGPRRC-NEXT:    v_mfma_f32_32x32x16_f16 v[16:31], v[32:35], v[36:39], v[0:15]
; VGPRRC-NEXT:    v_mov_b32_e32 v41, s13
; VGPRRC-NEXT:    v_mov_b32_e32 v42, s14
; VGPRRC-NEXT:    v_mov_b32_e32 v43, s15
; VGPRRC-NEXT:    s_nop 7
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mov_b32_e32 v0, s4
; VGPRRC-NEXT:    v_mov_b32_e32 v1, s5
; VGPRRC-NEXT:    v_mov_b32_e32 v2, s6
; VGPRRC-NEXT:    v_mov_b32_e32 v3, s7
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 v[8:23], v[0:3], v[4:7], v[8:23]
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    s_nop 2
...
; HEURRC-NEXT:    v_mov_b32_e32 v4, v12
; HEURRC-NEXT:    v_mov_b32_e32 v5, v13
; HEURRC-NEXT:    v_mov_b32_e32 v6, v14
; HEURRC-NEXT:    v_mov_b32_e32 v7, v15
; HEURRC-NEXT:    v_mov_b32_e32 v8, v16
; HEURRC-NEXT:    v_mov_b32_e32 v9, v17
; HEURRC-NEXT:    v_mov_b32_e32 v10, v18
; HEURRC-NEXT:    v_mov_b32_e32 v11, v19
; HEURRC-NEXT:    v_mov_b32_e32 v12, v20
; HEURRC-NEXT:    v_mov_b32_e32 v13, v21
; HEURRC-NEXT:    v_mov_b32_e32 v14, v22
; HEURRC-NEXT:    v_mov_b32_e32 v15, v23
; HEURRC-NEXT:    s_setpc_b64 s[30:31]
;
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 v[8:23], v[0:3], v[4:7], v[8:23] cbsz:1 abid:1 blgp:1
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    s_nop 2
; HEURRC-NEXT:    v_mov_b32_e32 v0, v8
; HEURRC-NEXT:    v_mov_b32_e32 v1, v9
...
; HEURRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
...
; HEURRC-NEXT:    v_mov_b64_e32 v[30:31], s[18:19]
; HEURRC-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; HEURRC-NEXT:    v_mov_b64_e32 v[28:29], s[16:17]
; HEURRC-NEXT:    v_mov_b64_e32 v[26:27], s[14:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[24:25], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[22:23], s[10:11]
; HEURRC-NEXT:    v_mov_b64_e32 v[20:21], s[8:9]
; HEURRC-NEXT:    v_mov_b64_e32 v[18:19], s[6:7]
; HEURRC-NEXT:    v_mov_b64_e32 v[16:17], s[4:5]
; HEURRC-NEXT:    v_mov_b32_e32 v40, s16
; HEURRC-NEXT:    v_mov_b32_e32 v41, s17
; HEURRC-NEXT:    v_mfma_f32_32x32x16_f16 v[0:15], v[32:35], v[36:39], v[16:31]
; HEURRC-NEXT:    v_mov_b32_e32 v42, s18
; HEURRC-NEXT:    v_mov_b32_e32 v43, s19
...
; HEURRC-NEXT:    s_waitcnt vmcnt(0)
; HEURRC-NEXT:    s_nop 0
; HEURRC-NEXT:    v_mov_b32_e32 v16, s4
; HEURRC-NEXT:    v_mov_b32_e32 v17, s5
; HEURRC-NEXT:    v_mov_b32_e32 v18, s6
; HEURRC-NEXT:    v_mov_b32_e32 v19, s7
...
; VGPRRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[34:35], s[22:23]
; VGPRRC-NEXT:    v_mov_b64_e32 v[32:33], s[20:21]
; VGPRRC-NEXT:    v_mov_b64_e32 v[38:39], s[26:27]
; VGPRRC-NEXT:    v_mov_b64_e32 v[30:31], s[18:19]
; VGPRRC-NEXT:    v_mov_b64_e32 v[36:37], s[24:25]
; VGPRRC-NEXT:    v_mov_b64_e32 v[28:29], s[16:17]
; VGPRRC-NEXT:    v_mov_b64_e32 v[26:27], s[14:15]
; VGPRRC-NEXT:    v_mov_b64_e32 v[24:25], s[12:13]
; VGPRRC-NEXT:    v_mov_b64_e32 v[22:23], s[10:11]
; VGPRRC-NEXT:    v_mov_b64_e32 v[20:21], s[8:9]
; VGPRRC-NEXT:    v_mov_b64_e32 v[18:19], s[6:7]
; VGPRRC-NEXT:    v_mov_b64_e32 v[16:17], s[4:5]
...
; VGPRRC-NEXT:    s_waitcnt vmcnt(0)
; VGPRRC-NEXT:    s_nop 0
; VGPRRC-NEXT:    v_mov_b32_e32 v16, s4
; VGPRRC-NEXT:    v_mov_b32_e32 v17, s5
; VGPRRC-NEXT:    v_mov_b32_e32 v18, s6
; VGPRRC-NEXT:    v_mov_b32_e32 v19, s7
...
; HEURRC-NEXT:    v_mov_b64_e32 v[8:9], s[12:13]
; HEURRC-NEXT:    v_mov_b64_e32 v[10:11], s[14:15]
; HEURRC-NEXT:    v_mov_b64_e32 v[12:13], s[16:17]
; HEURRC-NEXT:    v_mov_b64_e32 v[14:15], s[18:19]
; HEURRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; HEURRC-NEXT:    s_nop 0
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_i32_16x16x64_i8 v[0:3], v[0:3], v[4:7], v[8:11] cbsz:1 abid:1 blgp:1
; HEURRC-NEXT:    s_setpc_b64 s[30:31]
;
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x34
; HEURRC-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; HEURRC-NEXT:    s_load_dwordx4 s[12:15], s[0:1], 0x54
; HEURRC-NEXT:    v_mov_b32_e32 v12, 0
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b32_e32 v0, s4
...
; HEURRC-NEXT:    v_mov_b32_e32 v2, s6
; HEURRC-NEXT:    v_mov_b32_e32 v3, s7
; HEURRC-NEXT:    v_mov_b32_e32 v4, s8
; HEURRC-NEXT:    v_mov_b32_e32 v5, s9
; HEURRC-NEXT:    v_mov_b32_e32 v6, s10
; HEURRC-NEXT:    v_mov_b32_e32 v7, s11
; HEURRC-NEXT:    v_mov_b32_e32 v8, s12
; HEURRC-NEXT:    v_mov_b32_e32 v9, s13
; HEURRC-NEXT:    v_mov_b32_e32 v10, s14
; HEURRC-NEXT:    v_mov_b32_e32 v11, s15
...
; HEURRC-NEXT:    v_mfma_i32_16x16x64_i8 v[0:3], v[0:3], v[4:7], v[8:11]
; HEURRC-NEXT:    s_nop 6
; HEURRC-NEXT:    global_store_dwordx4 v12, v[0:3], s[2:3]
; HEURRC-NEXT:    s_endpgm
;
; VGPRRC-LABEL: test_mfma_i32_16x16x64_i8_no_agpr__vgprcd:
; VGPRRC:       ; %bb.0:
; VGPRRC-NEXT:    s_load_dwordx8 s[4:11], s[0:1], 0x34
; VGPRRC-NEXT:    s_load_dwordx2 s[2:3], s[0:1], 0x24
; VGPRRC-NEXT:    s_load_dwordx4 s[12:15], s[0:1], 0x54
; VGPRRC-NEXT:    v_mov_b32_e32 v12, 0
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b32_e32 v0, s4
...
; VGPRRC-NEXT:    v_mov_b32_e32 v8, s12
; VGPRRC-NEXT:    v_mov_b32_e32 v9, s13
; VGPRRC-NEXT:    v_mov_b32_e32 v10, s14
; VGPRRC-NEXT:    v_mov_b32_e32 v11, s15
; VGPRRC-NEXT:    s_nop 1
; VGPRRC-NEXT:    v_mfma_i32_16x16x64_i8 v[0:3], v[0:3], v[4:7], v[8:11]
; VGPRRC-NEXT:    s_nop 6
; VGPRRC-NEXT:    global_store_dwordx4 v12, v[0:3], s[2:3]
; VGPRRC-NEXT:    s_endpgm
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 v[8:23], v[0:3], v[4:7], v[8:23]
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    s_nop 2
; HEURRC-NEXT:    v_mov_b32_e32 v0, v8
; HEURRC-NEXT:    v_mov_b32_e32 v1, v9
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_i32_32x32x32_i8 v[8:23], v[0:3], v[4:7], v[8:23] cbsz:1 abid:1 blgp:1
; HEURRC-NEXT:    s_nop 7
; HEURRC-NEXT:    s_nop 2
; HEURRC-NEXT:    v_mov_b32_e32 v0, v8
; HEURRC-NEXT:    v_mov_b32_e32 v1, v9
...
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_load_dwordx8 s[16:23], s[0:1], 0x24
...
; HEURRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; HEURRC-NEXT:    v_mov_b32_e32 v36, s20
; HEURRC-NEXT:    v_mov_b32_e32 v37, s21
; HEURRC-NEXT:    v_mov_b32_e32 v38, s22
; HEURRC-NEXT:    v_mov_b32_e32 v39, s23
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[30:31], s[18:19]
; HEURRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; HEURRC-NEXT:    v_mov_b64_e32 v[28:29], s[16:17]
...
; VGPRRC:       ; %bb.0:
; VGPRRC-NEXT:    s_load_dwordx8 s[16:23], s[0:1], 0x24
...
; VGPRRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VGPRRC-NEXT:    v_mov_b32_e32 v36, s20
; VGPRRC-NEXT:    v_mov_b32_e32 v37, s21
; VGPRRC-NEXT:    v_mov_b32_e32 v38, s22
; VGPRRC-NEXT:    v_mov_b32_e32 v39, s23
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[30:31], s[18:19]
; VGPRRC-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0xa4
; VGPRRC-NEXT:    v_mov_b64_e32 v[28:29], s[16:17]
...
; HEURRC-NEXT:    v_mov_b32_e32 v19, s19
; HEURRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; HEURRC-NEXT:    v_mov_b32_e32 v20, s20
; HEURRC-NEXT:    v_mov_b32_e32 v21, s21
; HEURRC-NEXT:    v_mov_b32_e32 v22, s22
; HEURRC-NEXT:    v_mov_b32_e32 v23, s23
; HEURRC-NEXT:    s_waitcnt lgkmcnt(0)
; HEURRC-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; HEURRC-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; HEURRC-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
...
; VGPRRC-NEXT:    v_mov_b32_e32 v19, s19
; VGPRRC-NEXT:    s_load_dwordx16 s[4:19], s[0:1], 0x64
; VGPRRC-NEXT:    v_mov_b32_e32 v20, s20
; VGPRRC-NEXT:    v_mov_b32_e32 v21, s21
; VGPRRC-NEXT:    v_mov_b32_e32 v22, s22
; VGPRRC-NEXT:    v_mov_b32_e32 v23, s23
; VGPRRC-NEXT:    s_waitcnt lgkmcnt(0)
; VGPRRC-NEXT:    v_mov_b64_e32 v[0:1], s[4:5]
; VGPRRC-NEXT:    v_mov_b64_e32 v[2:3], s[6:7]
; VGPRRC-NEXT:    v_mov_b64_e32 v[4:5], s[8:9]
...
; SDAG:       ; %bb.0:
; SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SDAG-NEXT:    v_mfma_f32_16x16x32_bf16 v[0:3], v[0:3], v[4:7], v[8:11] cbsz:1 abid:1 blgp:1
; SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GISEL-NEXT:    v_mov_b32_sdwa v7, v15 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:WORD_0
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_mfma_f32_16x16x32_bf16 v[0:3], v[0:3], v[4:7], v[8:11] cbsz:1 abid:1 blgp:1
; GISEL-NEXT:    s_setpc_b64 s[30:31]
;
; HEURRC-LABEL: test_mfma_f32_16x16x32_bf16__flags:
; HEURRC:       ; %bb.0:
; HEURRC-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; HEURRC-NEXT:    v_mfma_f32_16x16x32_bf16 v[0:3], v[0:3], v[4:7], v[8:11] cbsz:1 abid:1 blgp:1
; HEURRC-NEXT:    s_setpc_b64 s[30:31]
;
