...
; GFX1032_DPP-NEXT:    s_mov_b32 s1, s2
...
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v0, s1
...
; GFX1032_DPP-NEXT:    s_or_b32 exec_lo, exec_lo, s0
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064_DPP-NEXT:    ds_add_u32 v3, v0
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064_DPP-NEXT:    buffer_gl0_inv
...
; GFX1032_DPP-NEXT:    v_mov_b32_e32 v0, v1
...
; GFX1132_DPP-NEXT:    v_mov_b32_e32 v0, v1
; GFX1132_DPP-NEXT:    s_mov_b32 s0, exec_lo
; GFX1132_DPP-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1132_DPP-NEXT:    v_cmpx_eq_u32_e32 0, v3
...
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_add_rtn_u64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    ds_add_rtn_u64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:  ; %bb.1:
; GFX8_DPP-NEXT:    v_mov_b32_e32 v6, s1
; GFX8_DPP-NEXT:    v_mov_b32_e32 v5, s0
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_add_u64 v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:  ; %bb.1:
; GFX9_DPP-NEXT:    v_mov_b32_e32 v6, s1
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s0
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_add_u64 v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v0, s0
; GFX1064_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1064_DPP-NEXT:    ds_sub_u32 v3, v0
; GFX1064_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1064_DPP-NEXT:    buffer_gl0_inv
...
; GFX1164_DPP-NEXT:  ; %bb.1:
; GFX1164_DPP-NEXT:    v_mov_b32_e32 v3, 0
; GFX1164_DPP-NEXT:    ds_sub_u32 v3, v0
; GFX1164_DPP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX1164_DPP-NEXT:    buffer_gl0_inv
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_sub_rtn_u64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_sub_rtn_u64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_ITERATIVE-NEXT:    s_lshl_b64 s[8:9], 1, s10
...
; GFX9_ITERATIVE-NEXT:    s_lshl_b64 s[8:9], 1, s10
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_and_rtn_b64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_and_rtn_b64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_or_rtn_b64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_or_rtn_b64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_xor_rtn_b64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_xor_rtn_b64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v2, s1, m0
; GFX7LESS_ITERATIVE-NEXT:    v_writelane_b32 v1, s0, m0
; GFX7LESS_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s10
...
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s10
; GFX8_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s9
...
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v3, s10
; GFX9_ITERATIVE-NEXT:    v_mov_b32_e32 v4, s9
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_max_rtn_i64 v[7:8], v0, v[7:8]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_max_rtn_i64 v[7:8], v0, v[7:8]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_min_rtn_i64 v[7:8], v0, v[7:8]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v7, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_min_rtn_i64 v[7:8], v0, v[7:8]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_max_rtn_u64 v[5:6], v0, v[5:6]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v5, s2
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_max_rtn_u64 v[5:6], v0, v[5:6]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX8_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX8_DPP-NEXT:    s_mov_b32 m0, -1
; GFX8_DPP-NEXT:    ds_min_rtn_u64 v[6:7], v0, v[6:7]
; GFX8_DPP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9_DPP-NEXT:    v_mov_b32_e32 v0, 0
; GFX9_DPP-NEXT:    ds_min_rtn_u64 v[6:7], v0, v[6:7]
; GFX9_DPP-NEXT:    s_waitcnt lgkmcnt(0)
