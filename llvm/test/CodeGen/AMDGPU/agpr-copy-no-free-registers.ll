...
; GFX908:       ; %bb.0: ; %bb
; GFX908-NEXT:    global_load_ushort v14, v[0:1], off glc
...
; GFX908-NEXT:    v_cvt_f32_f16_e32 v16, s2
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_readfirstlane_b32 s2, v14
...
; GFX908-NEXT:    global_load_dwordx2 v[0:1], v[0:1], off
...
; GFX908-NEXT:    v_readfirstlane_b32 s13, v1
...
; GFX908-NEXT:    v_add_co_u32_sdwa v0, vcc, v0, v14 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX908-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v1, vcc
; GFX908-NEXT:    s_add_u32 s20, s20, s4
; GFX908-NEXT:    v_cmp_lt_i64_e64 s[24:25], -1, v[0:1]
...
; GFX908-NEXT:    global_load_dword v19, v17, s[22:23] offset:-12 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v18, v17, s[22:23] offset:-8 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v10, v17, s[22:23] offset:-4 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    global_load_dword v10, v17, s[22:23] glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    ds_read_b64 v[10:11], v17
...
; GFX908-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX908-NEXT:    v_cvt_f32_f16_sdwa v20, v19 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX908-NEXT:    v_cvt_f32_f16_e32 v19, v19
; GFX908-NEXT:    v_cvt_f32_f16_sdwa v21, v18 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX908-NEXT:    v_cvt_f32_f16_e32 v18, v18
; GFX908-NEXT:    v_add_f32_e32 v22, v15, v10
; GFX908-NEXT:    v_add_f32_e32 v23, v16, v11
; GFX908-NEXT:    v_add_f32_e32 v24, 0, v10
; GFX908-NEXT:    v_add_f32_e32 v25, 0, v11
; GFX908-NEXT:    v_add_f32_e32 v13, v20, v13
; GFX908-NEXT:    v_add_f32_e32 v12, v19, v12
; GFX908-NEXT:    v_add_f32_e32 v11, v21, v11
; GFX908-NEXT:    v_add_f32_e32 v10, v18, v10
; GFX908-NEXT:    v_add_f32_e32 v3, v3, v23
; GFX908-NEXT:    v_add_f32_e32 v2, v2, v22
...
; GFX90A:       ; %bb.0: ; %bb
; GFX90A-NEXT:    global_load_ushort v16, v[0:1], off glc
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_readfirstlane_b32 s2, v16
...
; GFX90A-NEXT:    v_readfirstlane_b32 s13, v3
...
; GFX90A-NEXT:    v_add_co_u32_sdwa v2, vcc, v2, v16 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v3, vcc
; GFX90A-NEXT:    s_add_u32 s20, s20, s4
; GFX90A-NEXT:    s_addc_u32 s21, s21, s5
; GFX90A-NEXT:    v_cmp_lt_i64_e64 s[24:25], -1, v[2:3]
...
; GFX90A-NEXT:    global_load_dword v19, v17, s[22:23] offset:-12 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v18, v17, s[22:23] offset:-8 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v12, v17, s[22:23] offset:-4 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    global_load_dword v12, v17, s[22:23] glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    ds_read_b64 v[12:13], v17
...
; GFX90A-NEXT:    ; in Loop: Header=BB3_5 Depth=2
; GFX90A-NEXT:    v_cvt_f32_f16_sdwa v21, v19 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; GFX90A-NEXT:    v_cvt_f32_f16_e32 v20, v19
...
; GFX90A-NEXT:    v_pk_add_f32 v[12:13], v[18:19], v[12:13]
