...
; GFX9-O0-NEXT:    buffer_store_dword v47, off, s[0:3], s32 offset:168 ; 4-byte Folded Spill
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
...
; GFX9-O0-NEXT:    buffer_load_dword v39, off, s[0:3], s32 offset:96 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v14, v38
; GFX9-O0-NEXT:    buffer_load_dword v38, off, s[0:3], s32 offset:100 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v15, v37
; GFX9-O0-NEXT:    buffer_load_dword v37, off, s[0:3], s32 offset:104 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v16, v36
; GFX9-O0-NEXT:    buffer_load_dword v36, off, s[0:3], s32 offset:108 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    v_mov_b32_e32 v17, v35
; GFX9-O0-NEXT:    buffer_load_dword v35, off, s[0:3], s32 offset:112 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_waitcnt vmcnt(5)
; GFX9-O0-NEXT:    v_mov_b32_e32 v18, v34
; GFX9-O0-NEXT:    buffer_load_dword v34, off, s[0:3], s32 offset:116 ; 4-byte Folded Reload
...
; GFX9-O0-NEXT:    s_mov_b64 exec, -1
; GFX9-O0-NEXT:    buffer_load_dword v47, off, s[0:3], s32 offset:168 ; 4-byte Folded Reload
; GFX9-O0-NEXT:    s_mov_b64 exec, s[34:35]
; GFX9-O0-NEXT:    s_waitcnt vmcnt(0)
; GFX9-O0-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, v3
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, v4
; GFX9-O3-NEXT:    s_not_b64 exec, exec
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, 0
; GFX9-O3-NEXT:    s_not_b64 exec, exec
...
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, v5
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, v6
; GFX9-O3-NEXT:    s_not_b64 exec, exec
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, 0
; GFX9-O3-NEXT:    s_not_b64 exec, exec
...
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, v7
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, v8
; GFX9-O3-NEXT:    s_not_b64 exec, exec
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, 0
; GFX9-O3-NEXT:    s_not_b64 exec, exec
...
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, v9
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, v10
; GFX9-O3-NEXT:    s_not_b64 exec, exec
; GFX9-O3-NEXT:    v_mov_b32_e32 v32, 0
; GFX9-O3-NEXT:    v_mov_b32_e32 v33, 0
; GFX9-O3-NEXT:    s_not_b64 exec, exec
