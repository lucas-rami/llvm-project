...
; GFX950-NEXT:    v_max_f64 v[82:83], v[2:3], v[34:35]
...
; GFX950-NEXT:    s_waitcnt vmcnt(25)
; GFX950-NEXT:    v_max_f64 v[84:85], v[4:5], v[36:37]
...
; GFX950-NEXT:    s_waitcnt vmcnt(25)
; GFX950-NEXT:    v_max_f64 v[86:87], v[6:7], v[38:39]
...
; GFX950-NEXT:    s_waitcnt vmcnt(25)
; GFX950-NEXT:    v_max_f64 v[2:3], v[0:1], v[48:49]
; GFX950-NEXT:    v_cmp_u_f64_e64 s[4:5], v[0:1], v[48:49]
; GFX950-NEXT:    s_waitcnt vmcnt(23)
; GFX950-NEXT:    v_max_f64 v[48:49], v[8:9], v[50:51]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[10:11], v[52:53]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[12:13], v[54:55]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[14:15], v[64:65]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[16:17], v[66:67]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[18:19], v[68:69]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[20:21], v[70:71]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[22:23], v[80:81]
...
; GFX950-NEXT:    v_max_f64 v[48:49], v[24:25], v[32:33]
; GFX950-NEXT:    v_cmp_u_f64_e32 vcc, v[24:25], v[32:33]
; GFX950-NEXT:    s_waitcnt vmcnt(4)
; GFX950-NEXT:    v_max_f64 v[32:33], v[26:27], v[34:35]
...
; GFX950-NEXT:    v_max_f64 v[32:33], v[28:29], v[36:37]
...
; GFX950-NEXT:    s_waitcnt vmcnt(0)
; GFX950-NEXT:    v_max_f64 v[32:33], v[30:31], v[38:39]
