...
; SDAG-NEXT:    v_ffbh_u32_e32 v26, v18
; SDAG-NEXT:    v_or_b32_e32 v1, v17, v19
; SDAG-NEXT:    v_subb_u32_e32 v27, vcc, 0, v9, vcc
; SDAG-NEXT:    v_min_u32_e32 v2, v21, v2
; SDAG-NEXT:    v_add_i32_e64 v21, s[4:5], 32, v26
; SDAG-NEXT:    v_ffbh_u32_e32 v28, v19
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[4:5], 0, v[0:1]
; SDAG-NEXT:    v_cmp_gt_i64_e64 s[6:7], 0, v[10:11]
; SDAG-NEXT:    v_cndmask_b32_e64 v26, v9, v27, s[6:7]
; SDAG-NEXT:    v_subb_u32_e32 v0, vcc, 0, v10, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v27, v8, v3, s[6:7]
; SDAG-NEXT:    v_min_u32_e32 v1, v21, v28
...
; SDAG-NEXT:    v_lshl_b64 v[20:21], v[18:19], v34
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, 64, v34
; SDAG-NEXT:    v_lshl_b64 v[32:33], v[16:17], v34
...
; SDAG-NEXT:    v_cndmask_b32_e64 v11, 0, v33, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v10, 0, v32, s[4:5]
...
; SDAG-NEXT:    v_lshr_b64 v[20:21], v[16:17], v28
...
; SDAG-NEXT:    v_or_b32_e32 v8, v21, v38
; SDAG-NEXT:    v_or_b32_e32 v20, v20, v37
...
; SDAG-NEXT:    v_cndmask_b32_e64 v21, 0, v36, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v20, 0, v35, s[4:5]
...
; SDAG-NEXT:    v_and_b32_e32 v20, v8, v26
...
; SDAG-NEXT:    v_subb_u32_e32 v20, vcc, v16, v38, vcc
; SDAG-NEXT:    v_subb_u32_e32 v21, vcc, v21, v39, vcc
...
; SDAG-NEXT:    v_or_b32_e32 v1, v37, v1
; SDAG-NEXT:    s_or_b64 s[10:11], vcc, s[10:11]
; SDAG-NEXT:    v_or_b32_e32 v0, v36, v0
...
; SDAG-NEXT:    v_add_i32_e64 v26, s[4:5], 32, v3
; SDAG-NEXT:    v_subb_u32_e32 v27, vcc, 0, v13, vcc
; SDAG-NEXT:    v_or_b32_e32 v3, v5, v9
; SDAG-NEXT:    v_add_i32_e64 v10, s[4:5], 32, v10
; SDAG-NEXT:    v_ffbh_u32_e32 v28, v9
; SDAG-NEXT:    v_min_u32_e32 v6, v26, v6
; SDAG-NEXT:    v_subb_u32_e32 v29, vcc, 0, v14, vcc
; SDAG-NEXT:    v_cmp_gt_i64_e64 s[4:5], 0, v[14:15]
; SDAG-NEXT:    v_cndmask_b32_e64 v26, v13, v27, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v27, v12, v7, s[4:5]
; SDAG-NEXT:    v_cmp_eq_u64_e64 s[6:7], 0, v[2:3]
; SDAG-NEXT:    v_min_u32_e32 v3, v10, v28
...
; SDAG-NEXT:    v_cndmask_b32_e64 v2, v14, v29, s[4:5]
; SDAG-NEXT:    v_ffbh_u32_e32 v12, v27
; SDAG-NEXT:    v_ffbh_u32_e32 v13, v26
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[8:9]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v7, 0, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v28, v6, v3, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v15, v10, s[4:5]
; SDAG-NEXT:    v_or_b32_e32 v6, v27, v2
; SDAG-NEXT:    v_ffbh_u32_e32 v10, v2
; SDAG-NEXT:    v_add_i32_e32 v12, vcc, 32, v12
; SDAG-NEXT:    v_or_b32_e32 v7, v26, v3
...
; SDAG-NEXT:    v_sub_i32_e32 v6, vcc, v6, v28
...
; SDAG-NEXT:    v_add_i32_e32 v28, vcc, 1, v6
; SDAG-NEXT:    v_sub_i32_e64 v12, s[4:5], 63, v6
; SDAG-NEXT:    v_addc_u32_e32 v29, vcc, 0, v7, vcc
; SDAG-NEXT:    v_lshl_b64 v[12:13], v[4:5], v12
; SDAG-NEXT:    v_addc_u32_e32 v30, vcc, 0, v10, vcc
; SDAG-NEXT:    v_addc_u32_e32 v31, vcc, 0, v11, vcc
; SDAG-NEXT:    v_or_b32_e32 v10, v28, v30
; SDAG-NEXT:    v_sub_i32_e32 v32, vcc, 0x7f, v6
; SDAG-NEXT:    v_or_b32_e32 v11, v29, v31
; SDAG-NEXT:    v_lshl_b64 v[6:7], v[8:9], v32
; SDAG-NEXT:    v_sub_i32_e32 v33, vcc, 64, v32
; SDAG-NEXT:    v_lshl_b64 v[14:15], v[4:5], v32
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[10:11]
; SDAG-NEXT:    v_lshr_b64 v[10:11], v[4:5], v33
...
; SDAG-NEXT:    v_lshr_b64 v[14:15], v[4:5], v28
; SDAG-NEXT:    v_sub_i32_e32 v12, vcc, 64, v28
; SDAG-NEXT:    v_subrev_i32_e32 v33, vcc, 64, v28
; SDAG-NEXT:    v_lshr_b64 v[35:36], v[8:9], v28
; SDAG-NEXT:    v_add_i32_e32 v32, vcc, -1, v27
; SDAG-NEXT:    s_mov_b64 s[10:11], 0
; SDAG-NEXT:    v_mov_b32_e32 v13, 0
; SDAG-NEXT:    v_lshl_b64 v[37:38], v[8:9], v12
; SDAG-NEXT:    v_lshr_b64 v[8:9], v[8:9], v33
; SDAG-NEXT:    v_addc_u32_e32 v33, vcc, -1, v26, vcc
; SDAG-NEXT:    v_or_b32_e32 v12, v15, v38
; SDAG-NEXT:    v_or_b32_e32 v14, v14, v37
; SDAG-NEXT:    v_addc_u32_e32 v34, vcc, -1, v2, vcc
; SDAG-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v28
; SDAG-NEXT:    v_cndmask_b32_e64 v9, v9, v12, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v8, v14, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v15, 0, v36, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v14, 0, v35, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v35, vcc, -1, v3, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v28
...
; SDAG-NEXT:    v_or_b32_e32 v7, v37, v7
; SDAG-NEXT:    v_or_b32_e32 v11, v5, v11
; SDAG-NEXT:    v_sub_i32_e32 v5, vcc, v32, v8
; SDAG-NEXT:    v_or_b32_e32 v6, v36, v6
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v33, v9, vcc
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v34, v12, vcc
; SDAG-NEXT:    v_subb_u32_e32 v5, vcc, v35, v15, vcc
; SDAG-NEXT:    v_ashrrev_i32_e32 v5, 31, v5
; SDAG-NEXT:    v_and_b32_e32 v14, v5, v27
; SDAG-NEXT:    v_and_b32_e32 v36, v5, v26
; SDAG-NEXT:    v_and_b32_e32 v37, v5, v2
; SDAG-NEXT:    v_and_b32_e32 v38, v5, v3
; SDAG-NEXT:    v_sub_i32_e32 v8, vcc, v8, v14
; SDAG-NEXT:    v_subb_u32_e32 v9, vcc, v9, v36, vcc
; SDAG-NEXT:    v_subb_u32_e32 v14, vcc, v12, v37, vcc
; SDAG-NEXT:    v_subb_u32_e32 v15, vcc, v15, v38, vcc
; SDAG-NEXT:    v_add_i32_e32 v28, vcc, -1, v28
; SDAG-NEXT:    v_addc_u32_e32 v29, vcc, -1, v29, vcc
; SDAG-NEXT:    v_addc_u32_e32 v30, vcc, -1, v30, vcc
; SDAG-NEXT:    v_addc_u32_e32 v31, vcc, -1, v31, vcc
; SDAG-NEXT:    v_or_b32_e32 v36, v28, v30
; SDAG-NEXT:    v_or_b32_e32 v37, v29, v31
; SDAG-NEXT:    v_cmp_eq_u64_e32 vcc, 0, v[36:37]
...
; SDAG-NEXT:    s_and_b64 s[8:9], s[6:7], vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v32, v16, 0, s[4:5]
; SDAG-NEXT:    s_and_saveexec_b64 s[6:7], s[8:9]
...
; SDAG-NEXT:    v_or_b32_e32 v27, v11, v19
; SDAG-NEXT:    v_or_b32_e32 v32, v10, v18
...
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    s_mov_b64 s[10:11], 0x7f
; SDAG-NEXT:    v_mov_b32_e32 v33, v26
...
; SDAG-NEXT:  ; %bb.8: ; %udiv-preheader
; SDAG-NEXT:    v_lshr_b64 v[20:21], v[10:11], v36
...
; SDAG-NEXT:    v_cndmask_b32_e64 v20, v51, v20, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e32 v23, v18, v11, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v22, v20, v10, vcc
; SDAG-NEXT:    v_mov_b32_e32 v20, 0
; SDAG-NEXT:    v_mov_b32_e32 v21, 0
...
; SDAG-NEXT:    v_or_b32_e32 v15, v53, v15
; SDAG-NEXT:    v_or_b32_e32 v13, v21, v13
; SDAG-NEXT:    v_or_b32_e32 v14, v52, v14
...
; SDAG-NEXT:    v_ashrrev_i32_e32 v21, 31, v18
; SDAG-NEXT:    v_and_b32_e32 v18, 1, v21
; SDAG-NEXT:    v_and_b32_e32 v52, v21, v7
; SDAG-NEXT:    v_and_b32_e32 v53, v21, v6
; SDAG-NEXT:    v_and_b32_e32 v54, v21, v34
; SDAG-NEXT:    v_and_b32_e32 v21, v21, v35
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[6:7]
; SDAG-NEXT:    v_mul_lo_u32 v18, v32, v3
; SDAG-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v32, v2, 0
; SDAG-NEXT:    v_mul_lo_u32 v19, v27, v2
; SDAG-NEXT:    v_mul_lo_u32 v25, v9, v31
; SDAG-NEXT:    v_mul_lo_u32 v36, v8, v30
; SDAG-NEXT:    v_mad_u64_u32 v[22:23], s[4:5], v31, v32, 0
; SDAG-NEXT:    v_mov_b32_e32 v24, 0
; SDAG-NEXT:    v_mul_lo_u32 v9, v21, v7
; SDAG-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v21, v6, 0
; SDAG-NEXT:    v_mul_lo_u32 v37, v20, v6
; SDAG-NEXT:    v_mul_lo_u32 v38, v15, v35
; SDAG-NEXT:    v_mul_lo_u32 v39, v14, v34
; SDAG-NEXT:    v_add_i32_e32 v13, vcc, v13, v18
; SDAG-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v30, v32, v[23:24]
...
; SDAG-NEXT:    v_mad_u64_u32 v[15:16], s[4:5], v31, v27, v[23:24]
; SDAG-NEXT:    v_xor_b32_e32 v18, v18, v28
; SDAG-NEXT:    v_add_i32_e64 v3, s[4:5], v3, v37
...
; SDAG-NEXT:    v_add_i32_e64 v9, s[4:5], v36, v9
...
; SDAG-NEXT:    v_cndmask_b32_e64 v23, v17, v3, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v22, v16, v2, s[4:5]
; SDAG-NEXT:    v_mov_b32_e32 v18, 0
; SDAG-NEXT:    v_mov_b32_e32 v19, 0
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:    s_xor_b64 s[8:9], exec, s[4:5]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v27, 0, v27, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v26, 0, v26, s[4:5]
; SDAG-NEXT:    v_addc_u32_e32 v37, vcc, -1, v11, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v30
; SDAG-NEXT:    v_cndmask_b32_e32 v25, v18, v1, vcc
; SDAG-NEXT:    v_cndmask_b32_e32 v24, v24, v0, vcc
; SDAG-NEXT:    v_mov_b32_e32 v28, 0
...
; SDAG-NEXT:    v_lshl_b64 v[20:21], v[20:21], 1
; SDAG-NEXT:    v_lshl_b64 v[26:27], v[26:27], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v38, 31, v25
; SDAG-NEXT:    v_lshl_b64 v[24:25], v[24:25], 1
; SDAG-NEXT:    v_lshrrev_b32_e32 v39, 31, v23
; SDAG-NEXT:    v_lshl_b64 v[22:23], v[22:23], 1
; SDAG-NEXT:    v_or_b32_e32 v21, v29, v21
; SDAG-NEXT:    v_or_b32_e32 v20, v28, v20
; SDAG-NEXT:    v_or_b32_e32 v26, v26, v38
; SDAG-NEXT:    v_or_b32_e32 v24, v24, v39
; SDAG-NEXT:    v_or_b32_e32 v22, v22, v18
; SDAG-NEXT:    v_sub_i32_e32 v18, vcc, v34, v24
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, v35, v25, vcc
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, v36, v26, vcc
; SDAG-NEXT:    v_subb_u32_e32 v18, vcc, v37, v27, vcc
; SDAG-NEXT:    v_ashrrev_i32_e32 v18, 31, v18
; SDAG-NEXT:    v_and_b32_e32 v28, v18, v8
; SDAG-NEXT:    v_and_b32_e32 v29, v18, v9
; SDAG-NEXT:    v_and_b32_e32 v38, v18, v10
; SDAG-NEXT:    v_and_b32_e32 v39, v18, v11
; SDAG-NEXT:    v_and_b32_e32 v18, 1, v18
; SDAG-NEXT:    v_sub_i32_e32 v24, vcc, v24, v28
; SDAG-NEXT:    v_subb_u32_e32 v25, vcc, v25, v29, vcc
; SDAG-NEXT:    v_subb_u32_e32 v26, vcc, v26, v38, vcc
; SDAG-NEXT:    v_subb_u32_e32 v27, vcc, v27, v39, vcc
...
; SDAG-NEXT:    v_or_b32_e32 v23, v17, v23
; SDAG-NEXT:    s_or_b64 s[10:11], vcc, s[10:11]
; SDAG-NEXT:    v_or_b32_e32 v22, v16, v22
; SDAG-NEXT:    v_mov_b32_e32 v29, v19
; SDAG-NEXT:    v_mov_b32_e32 v28, v18
; SDAG-NEXT:    s_andn2_b64 exec, exec, s[10:11]
...
; SDAG-NEXT:    s_or_b64 exec, exec, s[8:9]
; SDAG-NEXT:    v_lshl_b64 v[16:17], v[22:23], 1
