...
; GFX942-NEXT:    s_mov_b32 s6, 0x47004600
; GFX942-NEXT:    s_mov_b32 s7, 0x45004400
; GFX942-NEXT:    s_mov_b32 s8, 0x42004000
; GFX942-NEXT:  .LBB0_2: ; %.lr.ph
; GFX942-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx4 v[2:5], v6, s[2:3]
; GFX942-NEXT:    s_add_u32 s4, s4, 8
; GFX942-NEXT:    s_addc_u32 s5, s5, 0
; GFX942-NEXT:    v_cmp_lt_u64_e32 vcc, s[4:5], v[0:1]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_pk_add_f16 v5, v5, s6
; GFX942-NEXT:    v_pk_add_f16 v4, v4, s7
