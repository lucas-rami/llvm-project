...
private:
  ...
  struct ScoredRemat {
    ...
    /// Updates the rematerialization's score w.r.t. the current RP targets.
  ...
  private:
    ...
    /// Overall rematerialization score. Higher is better. Scoring components
    /// are mapped to bit ranges in the overall score.
    ///
