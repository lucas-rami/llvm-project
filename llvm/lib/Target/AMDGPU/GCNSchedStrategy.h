...
private:
  ...
  struct RematReg {
    ...
    /// Always equals \ref Beneficial | \ref MaybeBeneficial (to avoid
    /// recomputing this all the time). Represents all regions in which the
    /// rematerializable register is live.
    BitVector Live;
  ...
  private:
    ...
    /// FIXME: Need a good rationale for these numbers, which I don't know where
    /// to get from.
