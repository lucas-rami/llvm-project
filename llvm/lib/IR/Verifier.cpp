...
#include "llvm/IR/Metadata.def"
  ...
  void verifyAMDGPUFunctionAttrs(AttributeList Attrs);
...
void Verifier::verifyFunctionAttrs(FunctionType *FT, AttributeList Attrs,
  ...
  if (TT.isAMDGPU())
    verifyAMDGPUFunctionAttrs(Attrs);
}

void Verifier::verifyAMDGPUFunctionAttrs(AttributeList Attrs) {
  Attribute A = Attrs.getFnAttr("amdgpu-waves-per-eu");
  if (!A.isValid())
    return;
