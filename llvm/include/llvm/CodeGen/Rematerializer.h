...
private:
  ...
  /// When there are two ajacent rematerializable MIs and the later one is
  /// deleted, stores a mapping from the earlier one's index to the later one's
  /// index. If the earlier one is then rematerialized, this makes it possible
  /// to rematerialize it at the correct position after the later one is
  /// re-created.
